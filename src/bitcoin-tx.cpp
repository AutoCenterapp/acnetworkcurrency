...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s acnetwork-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  acnetwork-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded acnetwork transaction") + "\n" +
              "  acnetwork-tx [options] -create [commands]   " + _("Create hex-encoded acnetwork transaction") + "\n" +
              "\n";
