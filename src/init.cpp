...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/acnetwork-project/acnetwork>";
    const std::string URL_WEBSITE = "<https://acnetwork.org>";
